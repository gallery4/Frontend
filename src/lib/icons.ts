...
const PDF_IMAGE_SOURCE = `
    data:image/svg+xml;utf8,
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="16" fill="${PDF_ICON_COLOR}" class="bi bi-file-pdf" viewBox="-8 -8 32 32">
        <path d="M4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm0 1h8a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1"/>
...
const EPUB_IMAGE_SOURCE = `
    data:image/svg+xml;utf8,
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="${EPUB_ICON_COLOR}" class="bi bi-book" viewBox="-8 -8 32 32">
